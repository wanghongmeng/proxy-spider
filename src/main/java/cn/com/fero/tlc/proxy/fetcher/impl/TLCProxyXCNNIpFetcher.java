 ...
 */
public class TLCProxyXCNNIpFetcher extends TLCProxyIpFetcher {
    ...
    public List<String> doFetch() {
        try {
            TLCProxyLoggerUtil.getLogger().info("开始抓取西刺国内高匿代理");
            ...
            TLCProxyLoggerUtil.getLogger().info("抓取西刺国内高匿代理结束");
        }
    }
}
