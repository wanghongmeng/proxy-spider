...
public class TLCSpiderRequest {
    public static Map<String, Object> get(String url, boolean useProxy) {
        ...
        try {
            ...
            String responseContent = EntityUtils.toString(response.getEntity(), TLCSpiderConstants.SPIDER_CONST_CHARACTER_ENCODING);

            Map<String, Object> responseMap = new HashMap();
            responseMap.put(TLCSpiderConstants.SPIDER_CONST_RESPONSE_STATUS_CODE, response.getStatusLine().getStatusCode());
            responseMap.put(TLCSpiderConstants.SPIDER_CONST_RESPONSE_CONTENT, responseContent);
            return responseMap;
        } catch (Exception e) {
